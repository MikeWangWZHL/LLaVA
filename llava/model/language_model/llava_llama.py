...
class LlavaGeoLlamaForCausalLM(LlamaForCausalLM, LlavaGeoMetaForCausalLM):
    ...
    def __init__(self, config):
        ...
        self.num_patches = (self.model.get_vision_tower().config.image_size // self.model.get_vision_tower().config.patch_size) ** 2
        self.mae_decoder = ViTMAEDecoder(config.mae_decoder_config, self.num_patches)
    ...
    def patchify(self, pixel_values):
        ...
        """
        patch_size, num_channels = self.config.mae_decoder_config.patch_size, self.config.mae_decoder.num_channels
        # sanity checks
    ...
    def random_masking(self, sequence, noise=None):
        ...
        len_keep = int(seq_length * (1 - self.config.mae_decoder_config.mask_ratio))
    ...
    def mae_loss(self, pixel_values, pred, mask):
        ...
        if self.config.mae_decoder_config.norm_pix_loss:
    ...
    def forward(
        ...
        mae_decoder_outputs = self.mae_decoder(sequence_unmasked_with_cls)
