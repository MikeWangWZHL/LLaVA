...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda"):
    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            print('Loading non_lora_trainables:', non_lora_trainables.keys())
...
def load_pretrained_model_geo(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda"):
    kwargs = {"device_map": device_map}
    ...
    model_cls = MODEL_TYPE_TO_MODEL_CLASS[get_model_type_from_model_name(model_name)]
    print("Loading model class:", model_cls)
    ...
    if 'llava' in model_name.lower():
        ...
        image_processor = vision_tower.image_processor
        image_processors["original_image_processor"] = image_processor

        if hasattr(model, "geo_image_processor"):
            geo_image_processor = model.geo_image_processor
            image_processors["geo_image_processor"] = geo_image_processor
    ...
    return tokenizer, model, image_processors, context_len
