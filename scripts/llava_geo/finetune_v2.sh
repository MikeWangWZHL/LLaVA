...
deepspeed --include localhost:1 llava/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava_geo_7b/finetune_projection_w_mae_adapter_freeze_llm \
    --num_train_epochs 1 \
    ...
    --llava_geo_config_path ./llava/train/llava_geo_configs/llava_geo_v2_finetune.json \
