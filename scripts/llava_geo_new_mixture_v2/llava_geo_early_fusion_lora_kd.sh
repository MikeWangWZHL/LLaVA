...
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_kd_7b_ori-55k_l1-69k_stage1_v2
...
MODEL_PATH=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_kd_7b_ori-55k_l1-69k_stage1_v2
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_kd_7b_ori-33k_l1-69k_stage2_v2_lora
...
# # Job 2
# bash scripts/llava_geo_new_mixture_v2/llava_original_finetune_lora.sh


CUDA_ID=4

MODEL_BASE=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_kd_7b_ori-55k_l1-69k_stage1_v2
MODEL_PATH=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_kd_7b_ori-33k_l1-69k_stage2_v2_lora
