...
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_7b_ori-6k_geo-l1-76k_stage1_v2

# DATA_PATH=${DATA_DIR}/llava_geo_mix_merged_v2_stage2_ori-33k_geo-l1-69k.json
DATA_PATH=${DATA_DIR}/llava_geo_mix_merged_v2_stage2_ori-6k_geo-l1-69k.json
