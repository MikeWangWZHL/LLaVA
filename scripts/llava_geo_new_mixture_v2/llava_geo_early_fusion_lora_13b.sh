...
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_13b_ori-55k_l1-69k_stage1_v2
...
deepspeed --include localhost:0,4,5,6 --master_port 29501 llava/train/train_mem.py \
...
MODEL_PATH=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_13b_ori-55k_l1-69k_stage1_v2
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_13b_ori-33k_l1-69k_stage2_v2_lora
