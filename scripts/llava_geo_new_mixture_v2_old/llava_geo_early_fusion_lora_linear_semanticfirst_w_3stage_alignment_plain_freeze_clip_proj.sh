...
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_7b_ori-55k_geo-l1_tune_geo_projector_geofeatureonly_plain_stage0_v2
...
MODEL_PATH=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_7b_ori-55k_geo-l1_tune_geo_projector_geofeatureonly_plain_stage0_v2
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_7b_ori-55k_geo-l1_tune_geo_projector_freeze_clip_proj_plain_stage1_v2
DATA_PATH=${DATA_DIR}/llava_geo_mix_merged_v2_stage1_ori-55k_geo-l1-69k.json
...
# ### stage 2 ###
echo "stage 2 ..."
MODEL_PATH=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_7b_ori-55k_geo-l1_tune_geo_projector_freeze_clip_proj_plain_stage1_v2
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_7b_ori-33k_geo-l1_3stage-alignment_freeze_clip_proj_plain_stage2_v2_lora
BITS=16 # 16
BATCH_SIZE=16 # 16
GRAD_ACC_STEP=1 # 1
...
CUDA_ID=5
MODEL_BASE=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_7b_ori-55k_geo-l1_tune_geo_projector_freeze_clip_proj_plain_stage1_v2
MODEL_PATH=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/llava_geo_early_fusion_7b_ori-33k_geo-l1_3stage-alignment_freeze_clip_proj_plain_stage2_v2_lora
MODEL_NAME="llava_geo_early_fusion_7b_ori-33k_geo-l1_3stage-alignment_freeze_clip_proj_plain_stage2_v2_lora"
