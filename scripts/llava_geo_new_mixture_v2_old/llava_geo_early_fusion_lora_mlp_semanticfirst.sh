...
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/mlp_semanticfirst/llava_geo_early_fusion_7b_ori-55k_geo-l1-69k_stage1_mlp_semanticfirst
...
MODEL_PATH=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/mlp_semanticfirst/llava_geo_early_fusion_7b_ori-55k_geo-l1-69k_stage1_mlp_semanticfirst
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v3/mlp_semanticfirst/llava_geo_early_fusion_7b_ori-33k_geo-l1-69k_stage2_mlp_semanticfirst
