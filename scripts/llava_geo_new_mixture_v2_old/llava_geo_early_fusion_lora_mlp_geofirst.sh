...
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/mlp_geofirst/llava_geo_early_fusion_7b_ori-55k_geo-l1-69k_stage1_mlp_geofirst
...
deepspeed --include localhost:0,1,2,3 --master_port 29501 llava/train/train_mem.py \
    ...
    --llava_geo_config_path "${CODE_DIR}/llava/train/llava_geo_configs/llava_geo_earlyfusion_mlp_geofirst.json" \
...
MODEL_PATH=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v2/mlp_geofirst/llava_geo_early_fusion_7b_ori-55k_geo-l1-69k_stage1_mlp_geofirst
OUTPUT_DIR=${CODE_DIR}/checkpoints/llava_geo_new_mixture_v3/mlp_geofirst/llava_geo_early_fusion_7b_ori-33k_geo-l1-69k_stage2_mlp_geofirst
...
bash scripts/llava_geo_new_mixture_v2/llava_geo_early_fusion_lora_mlp_semanticfirst.sh