...
do
    ...
    OUTPUT_DIR=${CODE_DIR}/checkpoints/svg_probing/image_text_lora/${TASK_NAME}_from_llava_stage1
    mm_projector_path=${CODE_DIR}/checkpoints/projectors/llava-v1.5-mlp2x-336px-pretrain-vicuna-7b-v1.5/mm_projector.bin
    
    LR=2e-5
    deepspeed --include localhost:2,7 --master_port 29501  llava/train/train_mem.py \
